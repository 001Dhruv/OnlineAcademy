...
public class ExploreResponse {
    ...
    public ExploreResponse(int id, String course_name, String course_image, String course_description, String course_teacher_name, String created_at, String updated_at) {
        this.id = id;
